# Version 0.2.2
#  0.2.2 - 2020/07/01 - oborchert
#          * Added compilation fix for directory issue with openssl 
#            include directory. The fix was introduced into srx-crypto-api
#            in version 0.2.2 by kuehwanl.s
