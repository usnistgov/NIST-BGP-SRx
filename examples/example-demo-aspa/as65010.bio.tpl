ski_file    = "../opt/bgp-srx-examples/example-demo-aspa/ski-list.as65010.txt";
...
session = (
  {
    ...
    update = (  
              "10.10.0.0/20,    B4"   
              ,"10.10.32.0/19,  B4 {65011 65012}"
              ,"10.10.128.0/17, B4 {65013 65014}"
              ,"10.20.0.0/20,   B4 65020"
              ,"10.25.0.0/21,   B4 65020 65025"
              ,"10.25.0.0/22,   B4 65020 65025"
              ,"10.30.0.0/22,   B4 65020 65030"
              ,"10.30.0.0/23,   B4 65020 65030"
              ,"10.40.0.0/22,   B4 65020 65040"
             );
