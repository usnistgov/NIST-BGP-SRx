#!/bin/bash
# This script is auto-generated by BGP-SRx Software Suite Bundler V2.4.6

# Date: Thu Jul  2 01:37:32 EDT 2020
# CMD: /bin/get-BGPSRx 5.1.0
...
if [ ! $? -eq 0 ] ; then
  echo
  echo "Could not find installed binaries, call buildfile [buildBGP-SRx5.1.0.sh] first!"
  echo
  exit 1
fi
BIN_DIR=$LOC_DIR/bin
