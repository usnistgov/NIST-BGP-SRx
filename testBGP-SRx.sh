#!/bin/bash
# This script is auto-generated by BGP-SRx Software Suite Bundler V2.11

# Date: Sat Mar 27 00:14:34 EDT 2021
# CMD: /bin/get-BGPSRx -S

#!/bin/sh

echo "BGP-SRx Test script Version 2.11"
...
if [ ! $? -eq 0 ] ; then
  echo
  echo "Could not find installed binaries, call buildfile [buildBGP-SRx5.1.3.sh] first!"
  echo
  exit 1
fi
BIN_DIR=$LOC_DIR/bin
