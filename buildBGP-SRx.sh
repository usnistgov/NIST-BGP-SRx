#!/bin/bash
# This script is auto-generated by BGP-SRx Software Suite Bundler V5.5

# Date: Mon Jul 12 10:56:08 EDT 2021
# CMD: /bin/get-BGPSRx -S -i BGP-SRx-Latest --latest5

SCRIPTNAME='BGP-SRx Software Suite V5.1.7 Build script V5.5!'
...
LOC_PREFIX=$(echo $INSTALL_DIR/local-5.1.7 | sed -e "s/\/\.\//\//g")

# This is used for the .vscode json files.
REL_LOC_PREFIX="local-5.1.7"
