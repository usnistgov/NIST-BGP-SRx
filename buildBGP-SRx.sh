...
# Date: Fri Sep 10 19:16:58 EDT 2021
# CMD: /bin/get-BGPSRx -S -i BGP-SRx-Latest --latest5

SCRIPTNAME='BGP-SRx Software Suite V5.1.9 Build script V6.2!'
...
LOC_PREFIX=$(echo $INSTALL_DIR/local-5.1.9 | sed -e "s/\/\.\//\//g")

# This is used for the .vscode json files.
REL_LOC_PREFIX="local-5.1.9"
