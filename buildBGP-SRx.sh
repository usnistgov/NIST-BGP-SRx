...
# Date: Fri Sep 24 19:19:56 EDT 2021
# CMD: /bin/get-BGPSRx -S -i BGP-SRx-Latest --latest

SCRIPTNAME='BGP-SRx Software Suite V6.1.3 Build script V6.7!'
...
LOC_PREFIX=$(echo $INSTALL_DIR/local-6.1.3 | sed -e "s/\/\.\//\//g")

# This is used for the .vscode json files.
REL_LOC_PREFIX="local-6.1.3"
