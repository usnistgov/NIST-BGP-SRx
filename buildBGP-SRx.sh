#!/bin/bash
# This script is auto-generated by BGP-SRx Software Suite Bundler V8.2.1

# Date: Sun Sep 29 01:41:00 AM EDT 2024
# CMD: /usr/bin/get-BGPSRx -S -i BGP-SRx-Latest --latest

SCRIPTNAME='BGP-SRx Software Suite V6.3.3 Build script V8.2.1!'
...
LOC_PREFIX=$(echo $INSTALL_DIR/local-6.3.3 | sed -e "s/\/\.\//\//g")

# This is used for the .vscode json files.
REL_LOC_PREFIX="local-6.3.3"
