...
# Date: Fri Mar 20 11:48:11 EDT 2020
# CMD: /usr/local/bin/get-BGPSRx -s

SCRIPTNAME='BGP-SRx Software Suite V3.1.0 Build script!'
...
LOC_PREFIX=$(echo $INSTALL_DIR/local-3.1.0 | sed -e "s/\/\.\//\//g")
...
if [ $DO_SRxSnP -eq 1 ] ; then
  ...
  if [ $DO_CONFIGURE -eq 1 ] ; then
    ...
    checkConfig src
    ./configure --prefix=$LOC_PREFIX --with-libpatr CFLAGS="-O0 -g"
