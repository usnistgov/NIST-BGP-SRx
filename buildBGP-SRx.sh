#!/bin/bash
# This script is auto-generated by BGP-SRx Software Suite Bundler V6.3

# Date: Wed Sep 15 17:09:11 EDT 2021
# CMD: /bin/get-BGPSRx -S -i BGP-SRx-Latest --latest5

SCRIPTNAME='BGP-SRx Software Suite V5.1.10 Build script V6.3!'
...
LOC_PREFIX=$(echo $INSTALL_DIR/local-5.1.10 | sed -e "s/\/\.\//\//g")

# This is used for the .vscode json files.
REL_LOC_PREFIX="local-5.1.10"
