#!/bin/bash
# This script is auto-generated by BGP-SRx Software Suite Bundler V6.6

# Date: Thu Sep 23 20:54:07 EDT 2021
# CMD: /bin/get-BGPSRx -S -i BGP-SRx-Latest --latest5

SCRIPTNAME='BGP-SRx Software Suite V5.1.11 Build script V6.6!'
...
LOC_PREFIX=$(echo $INSTALL_DIR/local-5.1.11 | sed -e "s/\/\.\//\//g")

# This is used for the .vscode json files.
REL_LOC_PREFIX="local-5.1.11"
