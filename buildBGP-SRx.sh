#!/bin/bash
# This script is auto-generated by BGP-SRx Software Suite Bundler V6.7

# Date: Fri Sep 24 19:15:44 EDT 2021
# CMD: /bin/get-BGPSRx -S -i BGP-SRx-Latest --latest5

SCRIPTNAME='BGP-SRx Software Suite V5.1.12 Build script V6.7!'
...
LOC_PREFIX=$(echo $INSTALL_DIR/local-5.1.12 | sed -e "s/\/\.\//\//g")

# This is used for the .vscode json files.
REL_LOC_PREFIX="local-5.1.12"
