#!/bin/bash
# This script is auto-generated by BGP-SRx Software Suite Bundler V6.8

# Date: Tue Sep 28 17:59:53 EDT 2021
# CMD: /bin/get-BGPSRx -S -i BGP-SRx-Latest --latest5

SCRIPTNAME='BGP-SRx Software Suite V5.1.13 Build script V6.8!'
...
LOC_PREFIX=$(echo $INSTALL_DIR/local-5.1.13 | sed -e "s/\/\.\//\//g")

# This is used for the .vscode json files.
REL_LOC_PREFIX="local-5.1.13"
