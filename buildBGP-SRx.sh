...
# Date: Fri Jul  9 21:42:05 EDT 2021
# CMD: /bin/get-BGPSRx -S -i BGP-SRx-Latest --latest

SCRIPTNAME='BGP-SRx Software Suite V6.0.0 Build script V5.4!'
...
LOC_PREFIX=$(echo $INSTALL_DIR/local-6.0.0 | sed -e "s/\/\.\//\//g")

# This is used for the .vscode json files.
REL_LOC_PREFIX="local-6.0.0"
