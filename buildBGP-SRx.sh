#!/bin/bash
# This script is auto-generated by BGP-SRx Software Suite Bundler V8.1.7

# Date: Mon Aug 12 12:13:25 PM EDT 2024
# CMD: /usr/bin/get-BGPSRx -S -i BGP-SRx-Latest --latest

SCRIPTNAME='BGP-SRx Software Suite V6.3.1 Build script V8.1.7!'
...
LOC_PREFIX=$(echo $INSTALL_DIR/local-6.3.1 | sed -e "s/\/\.\//\//g")

# This is used for the .vscode json files.
REL_LOC_PREFIX="local-6.3.1"
...
function syntax_module()
{
  ...
  while [ "$1" != "" ] ; do
    case $1 in
      ...
      "SRxSnP") syntax_module_banner $1; $0 $1 -X srxsnp 1 --help -C -A ;;
      "QSRX") syntax_module_banner $1; $0 $1 -X qsrx 1 --help -C -A ;;
      "BIO") syntax_module_banner $1; $0 $1 -X bio 1 --help -C -A ;;
...
{
  echo
  echo "Syntax: $0 [-? [ <MOD>]*] | [SCA] [SRxSnP] [QSRx] [BIO] [EXAMPLES] [-A] [-T] [-C|-M|-B|-I|-D|-V|-R]"
  echo
  ...
  echo "                 MOD: SCA | SRxSnP | QSRx | BIO | EXAMPLES"
  echo
  ...
  echo "    -EI  Configure IP address aliases for examples if not enough addresses"
  echo "         are available!"
