#!/bin/bash
# This script is auto-generated by BGP-SRx Software Suite Bundler V7.0.0

# Date: Wed Dec 15 19:34:34 EST 2021
# CMD: /bin/get-BGPSRx -S -i BGP-SRx-Latest --latest

SCRIPTNAME='BGP-SRx Software Suite V6.1.5 Build script V7.0.0!'
...
LOC_PREFIX=$(echo $INSTALL_DIR/local-6.1.5 | sed -e "s/\/\.\//\//g")

# This is used for the .vscode json files.
REL_LOC_PREFIX="local-6.1.5"
