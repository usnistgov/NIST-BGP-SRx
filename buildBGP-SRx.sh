#!/bin/bash
# This script is auto-generated by BGP-SRx Software Suite Bundler V7.0.2

# Date: Fri Mar 25 03:57:25 EDT 2022
# CMD: /bin/get-BGPSRx -S -i BGP-SRx-Latest --latest

SCRIPTNAME='BGP-SRx Software Suite V6.2.0 Build script V7.0.2!'
...
LOC_PREFIX=$(echo $INSTALL_DIR/local-6.2.0 | sed -e "s/\/\.\//\//g")

# This is used for the .vscode json files.
REL_LOC_PREFIX="local-6.2.0"
