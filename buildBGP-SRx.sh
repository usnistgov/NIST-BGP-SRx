#!/bin/bash
# This script is auto-generated by BGP-SRx Software Suite Bundler V6.2

# Date: Fri Sep 10 19:22:39 EDT 2021
# CMD: /bin/get-BGPSRx -S -i BGP-SRx-Latest --latest

SCRIPTNAME='BGP-SRx Software Suite V6.1.0 Build script V6.2!'
...
LOC_PREFIX=$(echo $INSTALL_DIR/local-6.1.0 | sed -e "s/\/\.\//\//g")

# This is used for the .vscode json files.
REL_LOC_PREFIX="local-6.1.0"
