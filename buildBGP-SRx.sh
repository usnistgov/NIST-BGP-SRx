...
# Date: Thu Sep 23 20:59:44 EDT 2021
# CMD: /bin/get-BGPSRx -S -i BGP-SRx-Latest --latest

SCRIPTNAME='BGP-SRx Software Suite V6.1.2 Build script V6.6!'
...
LOC_PREFIX=$(echo $INSTALL_DIR/local-6.1.2 | sed -e "s/\/\.\//\//g")

# This is used for the .vscode json files.
REL_LOC_PREFIX="local-6.1.2"
