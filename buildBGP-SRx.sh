...
# Date: Tue Sep 28 18:14:26 EDT 2021
# CMD: /bin/get-BGPSRx -S -i BGP-SRx-Latest --latest

SCRIPTNAME='BGP-SRx Software Suite V6.1.4 Build script V6.8!'
...
LOC_PREFIX=$(echo $INSTALL_DIR/local-6.1.4 | sed -e "s/\/\.\//\//g")

# This is used for the .vscode json files.
REL_LOC_PREFIX="local-6.1.4"
